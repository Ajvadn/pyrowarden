...
const HockeyProject = () => {
  return (
    <ProjectPageLayout
      title="Hockey Performance Monitoring"
      subtitle="Advanced sensor technology for elite hockey performance tracking"
      imageUrl="/placeholder.svg"
      brandName="Professional Hockey League"
    >
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <p>
          ...
          Pyrowarden Technologies to create a solution that could capture detailed metrics during real skating sessions and 
      ...
      <p>
        Pyrowarden Technologies developed a specialized single-point IMU (Inertial Measurement Unit) system embedded directly 
