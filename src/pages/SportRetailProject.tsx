  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <p>
          A global sports retail leader approached Pyrowarden Technologies with a vision to revolutionize the development, 
      ...
      <p>
        Pyrowarden Technologies developed a comprehensive smart footwear R&D platform that includes:
      </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg mt-8 flex items-start">
        ...
        <div>
          ...
          <p>
            Pyrowarden Technologies continues to partner with this client on this R&D initiative to refine the prototype and 
