...
const FireCatProject = () => {
  return (
    ...
    >
      ...
      <p>
        Pyrowarden Technologies provided an end-to-end solution called the 6th SENSE, combining sophisticated AI-driven 
      ...
      <p>
        ...
        safety, and operational efficiency of high-risk personnel. Pyrowarden's innovative platform and specialized 
