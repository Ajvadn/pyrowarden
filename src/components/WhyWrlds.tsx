...
const WhyPyrowarden = () => {
  ...
  return <section id="why-pyrowarden" className="relative py-16 md:py-24 bg-white overflow-hidden">
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        margin: "-100px"
          ...
          <motion.p variants={itemVariants} className="text-gray-600 text-lg max-w-3xl mx-auto">
            In cybersecurity, having the right tools makes all the difference. We provide professional-grade equipment trusted by security experts worldwide.
          </motion.p>
        </motion.div>
        ...
        margin: "-100px"
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">Global cybersecurity market size, with increasing demand for professional security testing tools and equipment</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">
              of data breaches could be prevented with proper penetration testing and security assessment tools
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">
              Faster vulnerability detection with professional-grade tools compared to standard security software
            </p>
          </motion.div>
        </motion.div>
        ...
        <motion.div className="mb-12" initial="hidden" whileInView="visible" viewport={{
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional-grade security tools and equipment that empower cybersecurity professionals to excel in their field
            </p>
          </motion.div>
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Industry-standard tools used by top cybersecurity firms and ethical hackers worldwide.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Latest security research tools and hardware for advanced penetration testing.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Comprehensive documentation and technical support for all security tools.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Continuous Updates</h4>
                  <p className="text-gray-700">Regular firmware updates and new payloads to stay ahead of security trends.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
