...
const SEO: React.FC<SEOProps> = ({
  ...
  const currentUrl = `https://pyrowarden.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://pyrowarden.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    contactPoint: {
      ...
      email: 'info@pyrowarden.com'
    },
    sameAs: [
      'https://www.linkedin.com/company/pyrowarden-technologies',
      'https://twitter.com/pyrowarden'
    ]
  };
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
      name: author || 'Pyrowarden Technologies',
      url: 'https://pyrowarden.com'
    },
    publisher: {
      '@type': 'Organization',
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Pyrowarden Technologies" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://pyrowarden.com" />}
      ...
      <meta name="twitter:site" content="@pyrowarden" />
      <meta name="twitter:creator" content="@pyrowarden" />
